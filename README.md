...
Paper Gacha is a local desktop app for discovering research papers when you choose to explore. It has no server, no account, and no GitHub Actions or GitHub Pages dependency.
...
The desktop app never posts to Bluesky. The legacy command-line script remains available only if you deliberately want to post a selected daily collection.
